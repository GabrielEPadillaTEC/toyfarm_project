      ...
      body: SingleChildScrollView(
        child: FutureBuilder(
            future: profileViewModel
                .fetchUserProfile(userId.isNotEmpty ? userId : '0'),
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return Center(
                    ...
                    Text(
                      '$userId not found',
                      style:
                          TextStyle(color: Colors.grey[300]), // Very light gray
                    ),
                  ],
                ));
              } else {
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                              '${profileViewModel.userProfile.followers} Followers'),
                          const SizedBox(width: 10),
                          Text(
                              '${profileViewModel.userProfile.following}  Following'),
                        ],
                      ),
                      const SizedBox(height: 20),
                      ...
                      _buildStatsRow(context,
                          ...
                          label: 'Channel Views',
                          value:
                              '${profileViewModel.userProfile.channelViews}'),
                      _buildStatsRow(context,
                      ...
                      _buildStatsRow(context,
                          ...
                          value:
                              '${profileViewModel.userProfile.modelsCreated}'),
                    ],
                  ),
                );
              }
